---
title: memtree — Context rot, eliminated.
description: memtree intercepts every Claude Code tool call — native and MCP — and routes content through a persistent SQLite graph. Claude gets compact node references instead of raw data. 95–99% context reduction.
---
